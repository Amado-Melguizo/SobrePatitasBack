...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('amado','$2a$10$C3Uln5uqnzx/GswADURJGOIdBqYrly9731fnwKDaUdBkt/M3qvtLq',1, 'Amado', 'Melguizo','amado@sobrepatitas.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$RmdEsvEfhI7Rcm9f/uZXPebZVCcPC7ZXZwV51efAvMAp1rIaRAfPK',1, 'Admin', 'web','admin@sobrepatitas.com');
