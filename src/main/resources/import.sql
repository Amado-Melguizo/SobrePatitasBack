...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('amado','$2a$10$C3Uln5uqnzx/GswADURJGOIdBqYrly9731fnwKDaUdBkt/M3qvtLq',1, 'Andres', 'Guzman','profesor@bolsadeideas.com');
...
INSERT INTO productos (nombre, precio, create_at) VALUES('Camiseta de Animales', 15, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES('Bolso de piel sintetica', 20, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES('Sudadera de SobrePatitas', 20, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES('Comida de animales', 59, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES('Medicinas', 70, NOW());

/* Creamos algunas facturas */
INSERT INTO facturas (descripcion, observacion, cliente_id, create_at) VALUES('Factura productos comprados', null, 1, NOW());
...
INSERT INTO facturas (descripcion, observacion, cliente_id, create_at) VALUES('Factura  de medicinas', 'Vigilar dosis!', 1, NOW());
